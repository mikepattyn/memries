...
If coverage is already complete, skip straight to Run.
...
- Whether you committed e2e/ setup (yes/no) and the commit hash (empty if none)
- Whether this feature run succeeded (yes/no)
